...
new_file = """import { ISourceProvider, MediaSearchQuery, CanonicalStreamSource, ProviderHealth } from '../../types';
...
open('src/core/streams/sources/providers/StremioProvider.ts', 'w').write(new_file)
